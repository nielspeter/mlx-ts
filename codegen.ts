...
// wrappers. Run: bun codegen.ts   (writes generated.ts, prints a coverage report)
//
...
export const m = dlopen(${JSON.stringify(LIB)}, {
${symbolLines.join("\n")}
}).symbols as any;

export type Arr = number;
export type Vec = number;
export const enum Dtype { Bool, Uint8, Uint16, Uint32, Uint64, Int8, Int16, Int32, Int64, Float16, Float32, Float64, Bfloat16, Complex64 }
...
writeFileSync(`${import.meta.dir}/generated.ts`,
