...
these exactly. Run: python3 reference-chat.py -> writes chat-fixtures.json
"""
import json
from jinja2.sandbox import ImmutableSandboxedEnvironment

tmpl = json.load(open("tokenizer_config-qwen.json"))["chat_template"]
...
json.dump(out, open("chat-fixtures.json", "w"), ensure_ascii=False, indent=1)
